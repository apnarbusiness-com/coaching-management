        ...
        <main class="flex-1 overflow-y-auto p-4 md:p-8 bg-slate-50 dark:bg-background-dark transition-colors duration-300">
            ...
            <div class="mx-auto max-w-none flex flex-col gap-8">
                ...
                @if(in_array('subject_earnings_table', $visibleWidgets))
                        ...
                        <div {{-- class="w-full h-64 flex items-end gap-4 pt-8 relative" --}} class="relative h-64 w-full">
                            <canvas id="earningChart"></canvas>
                        </div>
                ...
                <!-- Level 4: Subject-wise Earning Table -->
                <div
                    class="flex flex-col gap-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
                    <div class="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-700">
                        <h3 class="text-slate-900 dark:text-white text-lg font-bold">Subject-wise Earnings</h3>
                        <div class="flex gap-2">
                            <button
                                class="flex items-center gap-2 px-3 py-2 bg-slate-50 dark:bg-[#282e39] hover:bg-slate-100 dark:hover:bg-[#374151] border border-slate-200 dark:border-none rounded-lg text-slate-700 dark:text-white text-sm transition-colors">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr
                                    class="bg-slate-50 dark:bg-slate-900/50 text-slate-500 dark:text-[#9da6b9] text-sm uppercase tracking-wider">
                                    <th class="p-4 font-medium border-b border-slate-200 dark:border-slate-700">Subject
                                        Name</th>
                                    <th class="p-4 font-medium border-b border-slate-200 dark:border-slate-700">Teacher
                                    </th>
                                    <th class="p-4 font-medium border-b border-slate-200 dark:border-slate-700">Students
                                        Count</th>
                                    <th class="p-4 font-medium border-b border-slate-200 dark:border-slate-700">Earning
                                        (Oct)</th>
                                    <th class="p-4 font-medium border-b border-slate-200 dark:border-slate-700">Status
                                    </th>
                                    <th class="p-4 font-medium border-b border-slate-200 dark:border-slate-700 text-right">
                                        Actions</th>
                                </tr>
                            </thead>
                            <tbody
                                class="text-slate-900 dark:text-white text-sm divide-y divide-slate-200 dark:divide-slate-700">
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                                    ...
                                    <td class="p-4 text-right">
                                        <button
                                            class="text-slate-500 dark:text-[#9da6b9] hover:text-slate-700 dark:hover:text-white p-2 hover:bg-slate-100 dark:hover:bg-[#282e39] rounded-lg transition-colors">
