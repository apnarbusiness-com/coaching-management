    ...
    <div class="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-4 md:p-8" style="margin-top: -2rem">
        <div class="max-w-4xl mx-auto flex flex-col gap-6 pb-12">
            ...
            <nav aria-label="Breadcrumb" class="flex">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <span class="material-symbols-outlined text-slate-400 text-[18px]">chevron_right</span>
                            <span class="ml-1 text-sm font-medium text-slate-900 md:ml-2 dark:text-white">Edit Class</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Edit Academic Class</h1>
                    <p class="mt-1 text-slate-500 dark:text-slate-400">Update the class name, code, academic year, sections, and shifts.</p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <input
                                    ...
                                    value="{{ old('class_name', $academicClass->class_name) }}" required />
                            ...
                            <div class="col-span-1">
                                ...
                                <input
                                    ...
                                    value="{{ old('academic_year', $academicClass->academic_year ? \Carbon\Carbon::parse($academicClass->academic_year)->format('Y-m-d') : '') }}" />
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('class_code', $academicClass->class_code) }}" />
