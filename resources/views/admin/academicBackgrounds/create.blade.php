...
@section('title', 'Academic Backgrounds — Create')
@section('content')
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-slate-900 md:ml-2 dark:text-white">
                                Create {{ trans('cruds.academicBackground.title_singular') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">
                        Create {{ trans('cruds.academicBackground.title_singular') }}
                    </h1>
                    <p class="mt-1 text-slate-500 dark:text-slate-400">Add entries like Science, Humanities, Business Studies.</p>
                </div>
            </div>

            <form method="POST" action="{{ route('admin.academic-backgrounds.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <input
                                    ...
                                    id="name" name="name" placeholder="e.g. Science" type="text"
                ...
                <div
                    ...
                    <button
                        ...
                        Save {{ trans('cruds.academicBackground.title_singular') }}
                    </button>
                </div>
            </form>
        </div>
