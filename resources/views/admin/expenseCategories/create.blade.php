...
@section('title', 'Expense Categories — Create')
@section('content')
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                            Create <span class="text-red-600">Expense Category</span>
                        </h1>
                        <p class="mt-2 text-slate-600 dark:text-slate-400 text-lg">
                            Define a new category for organizing expenditures.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="p-6 md:p-8 space-y-6">
                            ...
                            <div
                                ...
                                <p class="text-xs text-orange-700 dark:text-orange-400 font-medium leading-relaxed">
                                    <span class="material-symbols-outlined !text-[14px] align-middle mr-1">info</span>
                                    Categories help organize and track different types of expenses. Choose descriptive names
