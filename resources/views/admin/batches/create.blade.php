    ...
    <div class="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-4 md:p-8" style="margin-top: -2rem">
        <div class="max-w-4xl mx-auto flex flex-col gap-6 pb-12">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Create Batch</h1>
                    <p class="mt-1 text-slate-500 dark:text-slate-400">Set batch, fee type, schedule, and students.</p>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="col-span-1">
                            ...
                            <input
                                ...
                                id="batch_name" name="batch_name" type="text" value="{{ old('batch_name', '') }}"
                                required />
                        ...
                        <div class="col-span-1">
                            ...
                            <select
                                ...
                                <option value="" disabled {{ old('fee_type') ? '' : 'selected' }}>
                        ...
                        <div class="col-span-1">
                            ...
                            <input
                                ...
                                id="class_time" name="class_time" type="time" value="{{ old('class_time', '') }}"
                                required />
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <select
                                ...
                                @foreach (\App\Models\Batch::CLASS_DAY_SELECT as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ in_array($key, old('class_days', []), true) ? 'selected' : '' }}>
                                        {{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <select
                                ...
                                @foreach ($students as $id => $label)
                                    <option value="{{ $id }}"
                                        {{ in_array($id, old('students', []), false) ? 'selected' : '' }}>
                                        {{ $label }}</option>
                                @endforeach
                            </select>
