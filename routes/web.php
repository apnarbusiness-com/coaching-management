...
Route::get('/admission/check-email', [AdmissionApplicationController::class, 'checkEmail'])->name('admission.public.check-email');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::get('financial-ledgers/uncategorized-earning-details', 'FinancialLedgerController@getUncategorizedEarningDetails')->name('financial-ledgers.uncategorized-earning-details');
    Route::get('financial-ledgers/uncategorized-expense-details', 'FinancialLedgerController@getUncategorizedExpenseDetails')->name('financial-ledgers.uncategorized-expense-details');
    ...
    Route::post('teachers-payments/recalculate', [TeachersPaymentController::class, 'recalculate'])->name('teachers-payments.recalculate');
    ...
    Route::post('due-collections/collect-other-due', [DueCollectionController::class, 'collectOtherDue'])->name('due-collections.collect-other-due');
    ...
    Route::get('batch-attendances/view', [BatchAttendanceController::class, 'view'])->name('batch-attendances.view');
    Route::get('batch-attendances/view-compact', [BatchAttendanceController::class, 'viewCompact'])->name('batch-attendances.view-compact');
    Route::post('batch-attendances/update-remark', [BatchAttendanceController::class, 'updateRemark'])->name('batch-attendances.update-remark');
